...
# -*- coding: utf-8 -*-
#
# tornado_proxy_handlers documentation build configuration file, created by
...
project = 'tornado_proxy_handlers'
...
_version_py = os.path.join('..', 'tornado_proxy_handlers', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'tornado_proxy_handlersdoc'
...
latex_documents = [
    (master_doc, 'tornado_proxy_handlers.tex', 'tornado_proxy_handlers Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'tornado_proxy_handlers', 'tornado_proxy_handlers Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tornado_proxy_handlers', 'tornado_proxy_handlers Documentation',
     author, 'tornado_proxy_handlers', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    tornado_proxy_handlers_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tornado_proxy_handlers'))
